...
class STEP:
    ...
    def evolution_energy_means_new(self, filename, ebins=ebins,res = '1min', head = 0, period = None, window_width = 5, save = False, norm = False, overflow = True, esquare = False, box_list = False):
